    ...
    <Stack direction={["column", "row"]} h={["100vh"]}>
        <VStack w={"full"}>
            ...
            <VStack alignItems={"flex-start"} p={"8"} w={"full"} overflowY={"auto"}> 
                ...
                <Text>This is a sample video for testing. this is called description This is a sample video for testing. this is called description This is a sample vide</Text>
            </VStack>
        </VStack>
            <VStack 
            w={["full", "xl"]}
        ...
        >
        {
            ...
            <Button variant={"ghost"} colorScheme={"purple"} onClick={()=>setVideosSrc(item)}>
                Lecture-{index+1}
            </Button>
            ))
        }
